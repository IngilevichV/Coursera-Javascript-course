...
assert.equal(addTime('1asd2', 30, 30), undefined, 'При добавлении 30 мин. к 12:30 получится 13:00');
assert.equal(addTime(12, 30, 30), '13:00', 'При добавлении 30 мин. к 12:30 получится 13:00');
assert.equal(addTime(23, 59, 1540), '00:30', 'При добавлении 31 мин. к 23:59 получится 00:30');
